...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 6:
                ...
                this.categories.unshift(response.data); //because we will return back the data
    ...
    editCategory: function editCategory(category) {
      ...
      this.editCategoryData = _objectSpread({}, category); // or Object.assign({}, category)
              ...
              case 7:
                ...
                this.categories.map(function (category) {
                  if (category.id == response.data.id) {
                    ...
                    category.image = response.data.image;
