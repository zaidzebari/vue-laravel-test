...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    editProduct: function editProduct(product) {
      ...
      this.editProductData = _objectSpread({}, product); // or Object.assign({}, product)
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                formData.append("_method", "put"); // no need this of course this work for web route but for post it is not need automaticaly laravel will handle this will be usefull only with get method with web route
...
function http() {
  return axios__WEBPACK_IMPORTED_MODULE_1___default.a.create({
    ...
    headers: {
      Authorization: 'Bearer ' + _auth_service__WEBPACK_IMPORTED_MODULE_2__["getAccessToken"]() // credentials: "include",
